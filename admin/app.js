...
const SHOP_STATUS_CLASS  = { active: "status-done", pending: "status-new", suspended: "status-cancelled", rejected: "status-cancelled" };
const SHOP_STATUSES      = ["active", "pending", "suspended", "rejected"];
...
async function loadShops() {
  ...
  const q = document.getElementById("shops-search").value.trim().toLowerCase();
